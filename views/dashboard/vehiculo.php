    ...
    <div class="row">
        <div class="col-md-10" style="padding-top: 70px;">
            ...
            <form id="vehiculo" method='POST'>
                ...
                <div class="form-group">
                    <label>Apto vehiculo</label>
                    <select id="apto_vehiculo" name="apto_vehiculo">
                        <?php
                            foreach(Usuario::getAptoResidente() as $row)
                            {
                                 echo "<option value='".$row['numero_apto']."'>".$row['numero_apto']."</option>";
                            }
        ...
        <div class="col-md-10" style="padding-top: 60px;">
            ...
            <table class="table">
                ...
                foreach ( Vehiculo::getAllVehiculos()  as $key => $row) {
                    ...
                    echo "<td contenteditable='true'><p>".$row['apto_vehiculo']."</p></td>";
                    if( $row['id_tipo'] == 1){
